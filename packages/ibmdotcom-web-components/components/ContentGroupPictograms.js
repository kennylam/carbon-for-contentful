        ...
        return (
          <DDSPictogramItem>
            <svg
              ...
              xmlSpace="preserve"
            >
              <g id="touch_screen" style={{ stroke: "black" }}>
